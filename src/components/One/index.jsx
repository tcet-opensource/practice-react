...
function Index() {
  return (
    <div className="flex flex-col items-center justify-center  text-white  min-h-[80px]  px-12 pt-28 pb-32 relative">
      <div className="flex flex-col text-center justify-center font-medium leading-50 text-6xl ">
        Contact Us
      </div>
        {data.map((data) => (
          <div className="flex text-center justify-center text-[#E5E5E5] text-lg font-normal leading-8 w-full px-48 pt-14 pb-16 z-10">
            {data.content}
          </div>
        ))}
