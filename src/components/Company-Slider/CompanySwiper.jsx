  ...
  return (
    <>
      <div className="flex justify-center mb-6 space-x-4 bg-custom-bg 2xl:mb-9 xl:space-x-8 ">
        <div className="w-10 h-10 swiper-prev xl:w-14 xl:h-14 ">
          <img src="/pagination-default.svg.svg" alt="prev-image-btn" />
        </div>
        <div className="w-10 h-10 swiper-next bg-custom-bg xl:w-14 xl:h-14">
          <img
            src="/pagination-default.svg.svg"
            alt="next-image-btn"
      ...
      >
        <div>
          {slideObj.map((d, i) => (
            <SwiperSlide
              key={i}
              className="justify-between font-normal leading-7 text-center md:leading-8 lg:leading-9 2xl:leading-10 "
            >
              <p>{d.info}</p>
            </SwiperSlide>
          ))}
