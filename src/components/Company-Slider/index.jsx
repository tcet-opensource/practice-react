...
export default function Slider(){
    return(
        <div className="flex flex-col justify-center text-white h-100 p-4 bg-[#141619]">
            <div className="text-center">
                ...
                <div className='flex items-center justify-center'>
                    ...
                    <img src="CompanySliderSection/bitkub-logo-light-trimmed.png.png" alt="bitkub-logo" className='w-20 h-3 md:w-24 md:h-4 xl:w-32 xl:h-6 border-l-2 border-white-100 pl-2 md:pl-4'/>                 
                </div>
            </div>
        </div>
