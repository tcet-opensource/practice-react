...
export default function Slider(){
    return(
        <div className="flex flex-col justify-center text-white h-100 px-4 mt-24 sm:mt-0">
            <div className="text-center">
                <div className="font-medium text-4xl md:text-4xl lg:text-5xl xl:text-6xl mx-8 lg:mx-32 xl:mx-40 mt-2">We are in good company</div>
